  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-blue-100 to-blue-50 flex items-center justify-center">
        <div className="text-2xl font-semibold text-blue-900">Loading bikes...</div>
      </div>
    );
  }
            ...
            {bikes.map((bike) => (
              ...
              >
                ...
                <div className="space-y-2">
                  <h2 className="text-xl font-bold text-gray-800">{bike.model}</h2>
                  ...
                  <div className={`inline-block px-3 py-1 rounded-full text-sm font-semibold ${
                    ...
                    bike.status === "Sold" ? "bg-red-100 text-red-800" :
