...
const UpdateUsedBike = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage('Used bike updated successfully!');
      setTimeout(() => {
        navigate('/UsedBikes');
      }, 2000);
    } catch (err) {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white shadow-lg rounded-lg overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-800 px-6 py-4">
            <h1 className="text-2xl font-bold text-white">Update Used Bike</h1>
            <p className="text-green-100 mt-1">Modify used bike details including price, status, and other information</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="flex justify-end space-x-4 pt-6 border-t border-gray-200">
              ...
              <button
                type="submit"
                disabled={loading}
                className="px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loading ? 'Updating...' : 'Update Used Bike'}
              </button>
            </div>
          </form>
        </div>
